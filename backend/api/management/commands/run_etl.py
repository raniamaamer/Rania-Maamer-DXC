"""
DXC Tunisia -- ETL Pipeline v7
✅ FIXES v7 (par rapport à v6) :
  - ✅ FIX CRITIQUE double reset abandon_rate : suppression du 1er bloc redondant
    dans _transform() — le 2ème `df["abandon_rate"] = df.apply(abandoned/offered...)`
    écrasait les masques corrects → Luxottica tombait sur fallback brut
  - ✅ FIX abd_out_60 + abd_in_60 ajoutés dans hist_rows (_load)
    Étaient absents → DB = 0 → DeskLangueView Total Luxottica = 1.80% au lieu de 99.20%
"""
